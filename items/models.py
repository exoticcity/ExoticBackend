...
class Product(models.Model):
    ...
    BaseUnitOfMeasure = models.CharField(max_length=50, blank=True, null=True)
    ParentCategory = models.CharField(max_length=50, blank=True, null=True)
    ItemCategoryCode = models.CharField(max_length=50, blank=True, null=True)
    ...
    SalesUnitOfMeasure = models.CharField(max_length=50, blank=True, null=True)
    WeightDescription = models.CharField(max_length=10, blank=True, null=True)
    ...
    PurchasingCode = models.CharField(max_length=50, blank=True, null=True)
